    ...
    try:
        if os.path.isdir(html_path):
            for local_file in glob.glob(html_path + '/**'):
                ...
                print(destination_blob_name, remote_path)
            ...
            bucket_url = 'https://console.cloud.google.com/storage/browser/%s/%s?project=%s' %(gcs_bucket, destination_blob_name, project_id)
            return  bucket_url
        else:
